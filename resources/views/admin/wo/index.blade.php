                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex gap-2 justify-content-center">
                                    <a class="btn btn-warning btn-sm text-center" href="{{ route('wo.edit', $item->id) }}"
                                        role="button">Edit</a>
                                    <a class="btn btn-warning btn-sm text-center" href="{{ route('wo.show', $item->id) }}"
                                        role="button">Detail</a>
                                    <form action="{{ route('wo.destroy', $item->id) }}" method="post"
