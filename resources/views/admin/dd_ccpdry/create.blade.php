...
@section('content')
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('dd_ccpdry.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row row-cols-1 row-cols-lg-2">
                    <div class="form-group mb-3">
                        ...
                        <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                            name="tanggal" placeholder="Masukkan tanggal" value="{{ old('tanggal', date('Y-m-d')) }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input id="jam" type="time" class="form-control @error('jam') is-invalid @enderror"
                            name="jam" placeholder="Masukkan jam" value="{{ old('jam', date('H:i')) }}">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="dd1" type="float" class="form-control @error('dd1') is-invalid @enderror"
                                name="dd1" placeholder="Masukkan dd1" value="{{ old('dd1') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="dd2" type="float" class="form-control @error('dd2') is-invalid @enderror"
                                name="dd2" placeholder="Masukkan dd2" value="{{ old('dd2') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="dd3" type="float" class="form-control @error('dd3') is-invalid @enderror"
                                name="dd3" placeholder="Masukkan dd3" value="{{ old('dd3') }}">
                        ...
                        <div class=" mb-3">
                            ...
                            <input id="foto3" type="file" class="form-control @error('foto3') is-invalid @enderror"
                                name="foto3" placeholder="Masukkan foto3">
                            @error('foto3')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input id="dd4" type="float" class="form-control @error('dd4') is-invalid @enderror"
                                name="dd4" placeholder="Masukkan dd4" value="{{ old('dd4') }}">
                        ...
                        <div class=" mb-3">
                            ...
                            <input id="foto4" type="file" class="form-control @error('foto4') is-invalid @enderror"
                                name="foto4" placeholder="Masukkan foto4">
                            @error('foto4')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Get the current time and format it as HH:mm (24-hour format)
