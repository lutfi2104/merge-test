...
@section('content')
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('spec.update', $spec->id) }}" enctype="multipart/form-data" id="form-edit">
                @csrf
                @method('put')
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10">
                        <select id="produk_id" class="form-select @error('produk_id') is-invalid @enderror" name="produk_id"
                            style="pointer-events: none;">
                            <option value="" selected>Pilih Produk</option>
                            @foreach ($produks as $item)
                                <option value="{{ $item->id }}"
                                    {{ old('produk_id', $spec->produk_id) == $item->id ? 'selected' : '' }}>
                                    {{ $item->name }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <div class="d-flex w-100">
                            <div class="col-6">
                                <input type="text" class="form-control @error('bulk_density.min') is-invalid @enderror"
                                    name="bulk_density[min]" id="bulk_density.min"
                                    value="{{ old('bulk_density.min', $spec->bulk_density()->min) }}"
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control @error('bulk_density.max') is-invalid @enderror"
                                    name="bulk_density[max]" id="bulk_density.max"
                                    value="{{ old('bulk_density.max', $spec->bulk_density()->max) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('kadar_air') is-invalid @enderror" name="kadar_air"
                            id="kadar_air" value="{{ old('kadar_air', $spec->kadar_air) }}"
                            placeholder="masukan kadar_air produk">
                        @error('kadar_air')
                            <small class="text-danger">{{ $message }} </small>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('salinity') is-invalid @enderror"
                            name="salinity" id="salinity" value="{{ old('salinity', $spec->salinity) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('mesh_20') is-invalid @enderror" name="mesh_20"
                            id="mesh_20" value="{{ old('mesh_20', $spec->mesh_20) }}"
                            placeholder="masukan mesh_20 produk">
                        @error('mesh_20')
                            <small class="text-danger">{{ $message }} </small>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('mesh_40') is-invalid @enderror" name="mesh_40"
                            id="mesh_40" value="{{ old('mesh_40', $spec->mesh_40) }}"
                            placeholder="masukan mesh_40 produk">
                        @error('mesh_40')
                            <small class="text-danger">{{ $message }} </small>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('mesh_4') is-invalid @enderror" name="mesh_4"
                            id="mesh_4" value="{{ old('mesh_4', $spec->mesh_4) }}" placeholder="masukan mesh4 produk">
                        @error('mesh_4')
                            <small class="text-danger">{{ $message }} </small>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('mesh_4_6') is-invalid @enderror" name="mesh_4_6"
                            id="mesh_4_6" value="{{ old('mesh_4_6', $spec->mesh_4_6) }}"
                            placeholder="masukan mesh_4_6 produk">
                        @error('mesh_4_6')
                            <small class="text-danger">{{ $message }} </small>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        ...
                        <input type="text" class="form-control @error('mesh_5_6') is-invalid @enderror"
                            name="mesh_5_6" id="mesh_5_6" value="{{ old('mesh_5_6', $spec->mesh_5_6) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        ...
                        <input type="text" class="form-control @error('mesh_20_max') is-invalid @enderror"
                            name="mesh_20_max" id="mesh_20_max" value="{{ old('mesh_20_max', $spec->mesh_20_max) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('mesh_1_4') is-invalid @enderror"
                            name="mesh_1_4" id="mesh_1_4" value="{{ old('mesh_1_4', $spec->mesh_1_4) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('mesh_1_4_5') is-invalid @enderror"
                            name="mesh_1_4_5" id="mesh_1_4_5" value="{{ old('mesh_1_4_5', $spec->mesh_1_4_5) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('mesh_6') is-invalid @enderror"
                            name="mesh_6" id="mesh_6" value="{{ old('mesh_6', $spec->mesh_6) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('mesh_6_10') is-invalid @enderror"
                            name="mesh_6_10" id="mesh_6_10" value="{{ old('mesh_6_10', $spec->mesh_6_10) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('mesh_30') is-invalid @enderror"
                            name="mesh_30" id="mesh_30" value="{{ old('mesh_30', $spec->mesh_30) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('mesh_40_kurang') is-invalid @enderror"
                            name="mesh_40_kurang" id="mesh_40_kurang" value="{{ old('mesh_40_kurang', $spec->mesh_40_kurang) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control  @error('salmonella') is-invalid @enderror"
                            name="salmonella" id="salmonella" value="{{ old('salmonella', $spec->salmonella) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control @error('tpc') is-invalid @enderror" name="tpc"
                            id="tpc" value="{{ old('tpc', $spec->tpc) }}" placeholder="masukan nilai tpc produk">
                        @error('tpc')
                            <small class="text-danger">{{ $message }} </small>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control  @error('partical_size') is-invalid @enderror "
                            name="entero" id="partical_size" value="{{ old('entero', $spec->entero) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10 ">
                        <input type="text" class="form-control  @error('partical_size') is-invalid @enderror "
                            name="ym" id="ym" value="{{ old('ym', $spec->ym) }}"
            ...
            <div class="row mb-3">
                ...
                <a class="btn btn-primary col-md-2" href="{{ route('spec.index') }}" role="button">Kembali</a>
