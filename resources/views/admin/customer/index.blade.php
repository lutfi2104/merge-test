    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-md-end mb-4">
                <a class="btn btn-primary" href="{{ route('customer.create') }}" role="button">Tambah</a>
            </div>
                            ...
                            <td class="text-center">
                                <div class="d-flex gap-2 justify-content-center">
                                    <a class="btn btn-warning btn-sm text-center"
                                        href="{{ route('customer.edit', $item->id) }}" role="button">Edit</a>
                                    <a class="btn btn-warning btn-sm text-center"
                                        href="{{ route('customer.show', $item->id) }}" role="button">Detail</a>
