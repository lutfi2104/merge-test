...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('kalibrasi.update', $kalibrasi->id) }}" enctype="multipart/form-data" id="form-edit">
                @csrf
                @method('put')
                    ...
                    <div class="col">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="nama_alat" type="text"
                                ...
                                placeholder="Masukkan nama_alat" value="{{ old('nama_alat', $kalibrasi->nama_alat ) }}">
                        ...
                        <div class=" mb-3">
                            ...
                            <input id="merk" type="text" class="form-control @error('merk') is-invalid @enderror"
                                name="merk" placeholder="Masukkan merk" value="{{ old('merk', $kalibrasi->merk) }}">
                            @error('merk')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="type" type="text" class="form-control @error('type') is-invalid @enderror"
                                name="type" placeholder="Masukkan type" value="{{ old('type', $kalibrasi->type) }}">
                        ...
                        <div class=" mb-3">
                            <label for="nomor_seri">Nomer Seri</label>
                            <input id="nomor_seri" type="text"
                                class="form-control @error('nomor_seri') is-invalid @enderror" name="nomor_seri"
                                placeholder="Masukkan Nomor Seri" value="{{ old('nomor_seri', $kalibrasi->nomor_seri) }}">
                            @error('nomor_seri')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input id="rentang_ukur" type="text"
                                ...
                                placeholder="Masukkan rentang_ukur" value="{{ old('rentang_ukur', $kalibrasi->rentang_ukur) }}">
                        ...
                        <div class=" mb-3">
                            ...
                            <input id="tgl_kalibrasi" type="date"
                                ...
                                placeholder="Masukkan tgl_kalibrasi" value="{{ old('tgl_kalibrasi', $kalibrasi->tgl_kalibrasi) }}">
                            @error('tgl_kalibrasi')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col">
                        <div class="form-group mb-3">
                            ...
                            <div class="form-check border rounded p-2 d-flex ">
                                <div class="form-check">
                                    <input class="form-check-input" name="kalibrasi" type="checkbox" value="kalibrasi" id="flexCheckkalibrasi" {{ $kalibrasi->kalibrasi == 'kalibrasi' ? 'checked' : ''}}>
                                    <label class="form-check-label" for="flexCheckkalibrasi">
                                        Kalibrasi
                                    </label>
                                </div>
                                <div class="form-check mx-5">
                                    <input class="form-check-input" name="verifikasi" type="checkbox" value="verifikasi" id="flexCheckverifikasi" {{ $kalibrasi->verifikasi == 'verifikasi' ? 'checked' : ''}}>
                                    <label class="form-check-label" for="flexCheckkalibrasi">
                                      Verifikasi
                                    </label>
                                  </div>
                        ...
                        <div class=" mb-3">
                            ...
                            <input id="resolusi" type="text"
                                ...
                                placeholder="Masukkan resolusi" value="{{ old('resolusi', $kalibrasi->resolusi) }}">
                            @error('resolusi')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input id="tempat" type="text" class="form-control @error('tempat') is-invalid @enderror"
                                name="tempat" placeholder="Masukkan tempat" value="{{ old('tempat' , $kalibrasi->tempat) }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="kalibrator" type="text" class="form-control @error('kalibrator') is-invalid @enderror"
                                name="kalibrator" placeholder="Masukkan kalibrator" value="{{ old('kalibrator' , $kalibrasi->kalibrator) }}">
