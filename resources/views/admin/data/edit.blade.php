...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('spec.update', $spec->id) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row mb-3">
                <div class="col-md-2">
                ...
                <div class="col-md-10">
                    <select id="produk_id" class="form-select @error('produk_id') is-invalid @enderror"
                        ...
                        <option value="{{ $item->id }}" {{old('produk_id', $spec->produk_id)==$item->id ?
                            'selected' : ''
                            }} >{{
                            $item->name }}</option>
                        @endforeach
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control @error('bulk_density') is-invalid @enderror"
                        name="bulk_density" id="bulk_density" value="{{ old('bulk_density',$spec->bulk_density) }}"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10 ">
                    <input type="text" class="form-control @error('nilai') is-invalid @enderror" name="nilai" id="nilai"
                        value="{{ old('nilai',$spec->nilai) }}" placeholder="masukan nilai produk">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10 ">
                    <input type="text" class="form-control @error('mesh_20') is-invalid @enderror" name="mesh_20"
                        id="mesh_20" value="{{ old('mesh_20',$spec->mesh_20) }}" placeholder="masukan mesh_20 produk">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10 ">
                    <input type="text" class="form-control @error('mesh_40') is-invalid @enderror" name="mesh_40"
                        id="mesh_40" value="{{ old('mesh_40',$spec->mesh_40) }}" placeholder="masukan mesh_40 produk">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10 ">
                    <input type="text" class="form-control @error('salinity') is-invalid @enderror" name="salinity"
                        id="salinity" value="{{ old('salinity',$spec->salinity) }}"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10 ">
                    <input type="text" class="form-control  @error('salmonella') is-invalid @enderror" name="salmonella"
                        id="salmonella" value="{{ old('salmonella',$spec->salmonella) }}"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10 ">
                    <input type="text" class="form-control @error('tpc') is-invalid @enderror" name="tpc" id="tpc"
                        value="{{ old('tpc',$spec->tpc) }}" placeholder="masukan nilai tpc produk">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10 ">
                    <input type="text" class="form-control  @error('partical_size') is-invalid @enderror " name="entero"
                        id="partical_size" value="{{ old('entero',$spec->entero) }}"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10 ">
                    <input type="text" class="form-control  @error('partical_size') is-invalid @enderror " name="ym"
                        id="ym" value="{{ old('ym',$spec->ym) }}" placeholder="masukan nilai Yeast & Mold">
